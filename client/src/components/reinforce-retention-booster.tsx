...
import { RetentionSessionCard, getMasteryLabel } from '@/components/retention-session-card';
...
export function getDailySessionCap(studyMode: string | undefined, examDate: string | Date | null | undefined, week: number): number {
  let cap: number;
