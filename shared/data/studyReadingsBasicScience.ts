    ...
    sections: [
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VI, Ch 32-33', topic: 'Environmental constraints, regulatory overview' },
        ],
      },
      {
        id: 'fs-d14-bs-s10',
    ...
    sections: [
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic II, Ch 16; Topic III, Ch 17', topic: 'Traverse, angle measurement, instrument types' },
        ],
      },
      {
        id: 'fs-d3-hm-s4',
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Photogrammetric mapping and remote sensing' },
        ],
      },
      {
        id: 'fs-d3-hm-s6',
