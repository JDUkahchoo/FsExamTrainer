      ...
      },
      {
        ...
        workedExample: {
          ...
          steps: [
            ...
            { step: 2, description: 'Pair B: S 62°44\'20"W (SW) and S 19°08\'40"E (SE). Both bearings are in the south hemisphere — same N/S side, different E/W. Apply Rule 2: add the bearing angles.', calculation: 'Azimuth check: S62°44\'20"W = 242°44\'20"; S19°08\'40"E = 160°51\'20"\nDifference = 242°44\'20" − 160°51\'20" = 81°53\'00"\nRule 2 result: 62°44\'20" + 19°08\'40" = 81°53\'00" ✓' },
            { step: 3, description: 'Pair C: N 35°10\'00"E (NE) and S 41°25\'30"E (SE). These cross the N-S equator on the same east side — NE + SE pair. Apply Rule 3: add, then subtract from 180°.', calculation: 'Azimuth check: N35°10\'00"E = 35°10\'00"; S41°25\'30"E = 138°34\'30"\nDifference = 138°34\'30" − 35°10\'00" = 103°24\'30"\nRule 3 result: 180° − (35°10\'00" + 41°25\'30") = 180° − 76°35\'30" = 103°24\'30" ✓' },
          ],
          answer: 'Pair A = 19°06\'40" (Rule 1 — same NE quadrant, subtract). Pair B = 81°53\'00" (Rule 2 — both south, different E/W, add). Pair C = 103°24\'30" (Rule 3 — NE+SE same east side, subtract sum from 180°). The azimuth-difference check confirms each result.',
        },
        bookRefs: [
      ...
      },
      {
        ...
        workedExample: {
          ...
          steps: [
            ...
            { step: 4, description: 'Compute the angle at S¼ (interior angle of the triangle at vertex S¼). The two bearings from S¼ are: N 43°20\'24"W toward W¼ (baseline direction) and N 02°08\'19"E toward C¼. Both are northward, different E/W — NW + NE pair. Apply Rule 2: add.', calculation: 'Bearing S¼ to W¼ = N 43°20\'24"W (NW quadrant, angle = 43°20\'24")\nBearing S¼ to C¼ = N 02°08\'19"E (NE quadrant, angle = 02°08\'19")\nRule 2 (NW + NE): Angle at S¼ = 43°20\'24" + 02°08\'19" = 45°28\'43"\n\nAzimuth check: W¼ direction = 360° − 43°20\'24" = 316°39\'36"; C¼ direction = 02°08\'19"\nAngle = 316°39\'36" − 02°08\'19" = 314°31\'17"; reflex → 360° − 314°31\'17" = 45°28\'43" ✓' },
            { step: 5, description: 'Compute the angle at W¼. The two bearings from W¼ are: S 43°20\'24"E toward S¼ (baseline reversed) and S 88°46\'23"E toward C¼. Both are SE — same quadrant. Apply Rule 1: subtract. Then find angle at C¼ and apply Law of Sines.', calculation: 'Bearing W¼ to S¼ = S 43°20\'24"E (SE quadrant, angle = 43°20\'24")\nBearing W¼ to C¼ = S 88°46\'23"E (SE quadrant, angle = 88°46\'23")\nRule 1 (SE + SE): Angle at W¼ = 88°46\'23" − 43°20\'24" = 45°25\'59"\n\nAngle at C¼ = 180° − 45°28\'43" − 45°25\'59" = 89°05\'18"\n\nLaw of Sines: baseline/sin(C¼) = dist(S¼ to C¼)/sin(angle at W¼)\n3626.65/sin 89°05\'18" = dist/sin 45°25\'59"\ndist(S¼ to C¼) = 3626.65 × sin 45°25\'59"/sin 89°05\'18" = 3626.65 × 0.71147/0.99989 = 2,580.3\'' },
            { step: 6, description: 'Compute coordinates of C¼ from S¼ using bearing N02°08\'19"E and distance 2,580.3\'.', calculation: 'ΔN = cos(2°08\'19") × 2580.3 = 0.99930 × 2580.3 = 2,578.5\'\nΔE = sin(2°08\'19") × 2580.3 = 0.03726 × 2580.3 = 96.1\'\nC¼ North = 10,008.06 + 2,578.5 = 12,586.6\'\nC¼ East = 7,510.70 + 96.1 = 7,606.8\'' },
          ],
          answer: 'Center Quarter Corner coordinates: N ≈ 12,586.6\', E ≈ 7,606.8\'. Angles: at S¼ = 45°28\'43" (NW+NE, Rule 2); at W¼ = 45°25\'59" (SE-SE, Rule 1); at C¼ = 89°05\'18". The procedure — inverse baseline, apply bearing rules for interior angles, Law of Sines for distance, COGO for coordinates — is the standard sequence for all bearing-bearing intersections.',
        },
        bookRefs: [
      ...
      },
      {
        ...
        workedExample: {
          ...
          steps: [
            ...
            { step: 3, description: 'Compute angle at B: between baseline B-to-A (due west = N 90°00\'W) and bearing B-to-P (N 40°00\'W). Both are NW — same quadrant. Apply Rule 1: subtract.', calculation: 'Bearing B to A = N 90°00\'00"W (due west, NW quadrant, angle = 90°)\nBearing B to P = N 40°00\'00"W (NW quadrant, angle = 40°)\nRule 1 (NW + NW): Angle at B = 90°00\'00" − 40°00\'00" = 50°00\'00"' },
