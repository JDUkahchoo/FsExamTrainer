    ...
    sections: [
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Photogrammetry fundamentals' },
        ],
      },
      {
        id: 'fs-d2-photo-s2',
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Photo scale and flying height' },
        ],
      },
      {
        id: 'fs-d2-photo-s3',
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Relief displacement formula and effects' },
        ],
      },
      {
        id: 'fs-d2-photo-s5',
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Overlap standards for aerial photography' },
        ],
      },
      {
        id: 'fs-d2-photo-s8',
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Number of photos and strips' },
        ],
      },
      {
        id: 'fs-d2-photo-s9',
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Ground control for photogrammetric mapping' },
      ...
      },
      {
        ...
        bookRefs: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'Stereopairs, photo base, and parallax' },
        ],
      },
      {
        id: 'fs-d2-photo-s11',
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Ch 36', topic: 'LiDAR and digital photogrammetry comparison' },
      ...
      },
      {
        ...
        furtherReading: [
          ...
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic VII, Chapter 36 (Aerial Mapping)', topic: 'Photogrammetry fundamentals for the FS exam' },
