...
export const STUDY_READINGS_PS: ReadingModule[] = [
  ...
  // ============================================================
  {
    ...
    title: 'ALTA/NSPS Land Title Survey Standards (2026)',
    description: 'A comprehensive overview of the 2026 ALTA/NSPS Minimum Standard Detail Requirements for Land Title Surveys (effective February 23, 2026), including mandatory requirements, Table A optional items, and certification language.',
    estimatedMinutes: 24,
    sections: [
      {
        id: 'ps-d3-alta-s1',
      ...
      },
      {
        ...
        formula: {
          ...
          whenToUse: 'The 2026 ALTA/NSPS standards require a Relative Positional Precision of 2 cm (0.07 ft) plus 50 ppm or better, at the 95% confidence level, for all points on the survey relative to any other points on the survey. This standard applies to both boundary corners and improvements shown on the survey.',
        },
      },
      {
        id: 'ps-d3-alta-s4',
        ...
        knowledgeCheck: {
          question: 'Which of the following is a mandatory requirement of the 2026 ALTA/NSPS standards, NOT a Table A optional item?',
          options: [
      ...
      },
      {
        ...
        knowledgeCheck: {
          question: 'The 2026 ALTA/NSPS standards require a Relative Positional Precision of:',
          options: [
          ...
          correctIndex: 2,
          explanation: 'The 2026 ALTA/NSPS standards establish a Relative Positional Precision requirement of 2 cm (0.07 feet) plus 50 ppm or better at the 95% confidence level for all points shown on the survey, relative to any other points on the survey.',
        },
      },
    ],
  },
