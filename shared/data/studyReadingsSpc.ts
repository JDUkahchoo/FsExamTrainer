    ...
    sections: [
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 21', topic: 'State Plane Coordinate System — history and purpose' },
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 21', topic: 'Scale factor in State Plane zones' },
        ],
      },
      {
        id: 'fs-d7-spc-s4',
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 21', topic: 'Elevation factor and sea-level reduction' },
        ],
      },
      {
        id: 'fs-d7-spc-s5',
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 21', topic: 'Grid-to-ground distance conversions' },
        ],
      },
      {
        id: 'fs-d7-spc-kc2',
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 21', topic: 'SPCS zone structure and practical application' },
        ],
      },
      {
        id: 'fs-d7-spc-tips',
      ...
      },
      {
        ...
        furtherReading: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Chapter 21', topic: 'State Plane Coordinate System — projections, zones, and distance reduction' },
