    ...
    sections: [
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 23', topic: 'State Plane Coordinate System in professional surveys' },
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 23', topic: 'Grid vs geodetic north, convergence and (t − T)' },
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 23', topic: 'Azimuth reduction with convergence angle' },
        ],
      },
      {
        id: 'ps-d2-spc-kc2',
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 23', topic: 'NSRS modernization, SPCS 83 vs SPCS2022, datum transformations' },
      ...
      },
      {
        ...
        bookRefs: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Ch 23', topic: 'Low-distortion projections and SPCS deliverable documentation' },
        ],
      },
      {
        id: 'ps-d2-spc-tips',
      ...
      },
      {
        ...
        furtherReading: [
          { book: 'Surveyor Reference Manual (SRM)', chapter: 'Topic IV, Chapter 23', topic: 'State Plane Coordinate System — projections, convergence, and distance reduction' },
