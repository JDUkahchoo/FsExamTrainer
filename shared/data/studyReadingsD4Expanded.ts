...
export const STUDY_READINGS_D4_EXPANDED: ReadingModule[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'For deeper coverage of advanced geodesy topics:\n\n- Surveyor Reference Manual (Cole), Chapters 25-28: Geodesy, satellite positioning, and coordinate systems\n- Elementary Surveying (Ghilani & Wolf), Chapters 19-20: Control surveys, satellite positioning\n- NGS website (geodesy.noaa.gov): GEOID models, coordinate conversion tools, CORS data\n- NCEES FS Reference Handbook: Geodesy section\n- Torge & Muller, "Geodesy," for comprehensive treatment of physical and geometric geodesy',
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'For deeper coverage of historical methods, magnetic declination, and route surveying:\n\n- Elementary Surveying (Ghilani & Wolf), Chapters 7-8: Compass and transit surveys, magnetic declination\n- Elementary Surveying (Ghilani & Wolf), Chapters 24-25: Route surveying, highway curves, and alignment design\n- Surveyor Reference Manual (Cole), Chapters 13-14: Historical measurement methods\n- BLM Manual of Surveying Instructions (2009), Chapter 3: Original PLSS survey methods using compass and chain\n- NOAA Magnetic Declination Calculator (ngdc.noaa.gov): Current and historical declination values\n- NCEES FS Reference Handbook: Isogonic chart and declination information',
      },
    ],
  },
];
